...
C = 2.89e-12; % Χωρητικότητα πυκνωτή (2.99 pF)
...
l = 0.137;  % Μήκος γραμμών σε μονάδες μήκους κύματος
...
hold off;
title('Ισχύς σε mW συναρτήσει της συχνότητας πυκνωτής σε σειρά με είσοδο');
